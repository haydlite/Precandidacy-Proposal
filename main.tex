...
\cite{gallaherMainstreamingWhiteSupremacy2020, johndaniszewskiWritingAltright2016}. (Given the number of
overlapping descriptors related to the “alt-right”,  \ref{table:key-identifiers}
summarizes key groups to help clarify and contrast them from one
another.)  These caveats in mind, literature surrounding the ``alt-right” can be divided into two categories: One strand describes the ``alt-right'' as part
...
\begin{table*}
  ...
  \caption{Distinctions between Key Identifiers}
  \label{table:key-identifiers}
  
  \begin{tabular}{ p{4cm}  p{4cm}  p{4cm} }
  
    \toprule
     Identifier & Description &  Additional Notes\\ 
    \midrule
