...
\todo[inline, color=blue!55]{Standardize quotation mark use.}
\todo[inline, color=blue!55]{Add in citations.}
...
\todo[inline, color=orange!65]{Change the last sentence here to talk about how the existential threat from the alt-right is disinformation warfare -> collapse of democracy.}
...
The "alt-right" set themselves apart from other far-right movements with their emphasis on mainstreaming and their social media savvy. The latter trait enables the success of the first \cite{sternProudBoysWhite2019, nagleKillAllNormies2017, gallaherMainstreamingWhiteSupremacy2020}. \todo[inline, color=red!70]{Fix up this paragraph. Should read about mainstreaming -> political discourse focus warp}
...
\todo[inline, color=orange!65]{tighten lang here / better capture rib's con}
...
\todo[inline, color=yellow]{Clarify "idea" vs item of
...
\todo[inline, color=yellow!90]{Change "Prediction" $\rightarrow$ Language about modelling}
